...
| `L1_guid_dialect.dtsx` | Lesson 1, older save (`SSIS.Package.3`, format 6) | GUID | **The same logical package in the other dialect.** Source of the GUID↔name table and of the dialect-equivalence regression test. |
